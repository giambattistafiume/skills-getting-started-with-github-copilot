...
activities = {
    ...
    "Soccer Practice": {
        "description": "Team sports training and friendly matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "maya@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training, water safety, and relay competitions",
        "schedule": "Mondays and Wednesdays, 3:00 PM - 4:30 PM",
        "max_participants": 18,
        "participants": ["noah@mergington.edu", "lila@mergington.edu"]
    },
    "Art Workshop": {
        "description": "Explore painting, drawing, and mixed media projects",
        "schedule": "Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["zara@mergington.edu", "jason@mergington.edu"]
    },
    "Drama Club": {
